<native:scroll-view class="w-full bg-theme-background">
    <native:column class="w-full p-5 gap-5">
        ...
        <native:column class="gap-1">
            ...
            <native:text class="text-base text-theme-on-background">Value: {{ number_format($slideValue, 3) }}</native:text>
            <native:text class="text-base text-theme-on-background">Value: {{ number_format($slideValue * 12, 3) }}</native:text>
        </native:column>
