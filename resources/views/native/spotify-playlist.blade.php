    ...
    <column class="w-full gap-0">
        ...
        <column class="w-full px-4 gap-1">
            ...
            <row class="items-center gap-1 pt-1">
                <column class="w-[16] h-[16] rounded-full bg-[#1DB954] items-center justify-center">
                    <icon :ios="Ios::Person" :android="Android::Person" :size="10" color="#000000" />
                </column>
        ...
        <row class="w-full px-4 py-3 items-center justify-between">
            <row class="items-center gap-5">
                <icon :ios="Ios::Heart" :android="Android::FavoriteBorder" :size="24" color="#B3B3B3" />
                <icon :ios="Ios::ArrowDownCircle" :android="Android::Download" :size="24" color="#B3B3B3" />
                <icon :ios="Ios::SquareAndArrowUp" :android="Android::Share" :size="22" color="#B3B3B3" />
